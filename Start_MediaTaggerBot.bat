...
echo  Build MTB-0.5.9-PUBLIC-20260810-03
...
>> "%LOG_FILE%" echo BuildID: MTB-0.5.9-PUBLIC-20260810-03
...
set "MEDIATAGGERBOT_LAUNCHER_BUILD_ID=MTB-0.5.9-PUBLIC-20260810-03"
